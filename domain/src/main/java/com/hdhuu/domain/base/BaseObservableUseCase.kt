 ...
 */
abstract class BaseObservableUseCase<INPUT_DATA, RESPONSE_DATA> constructor(private val threadExecutor: ThreadExecutor, private val postExecutionThread: PostExecutionThread) {
